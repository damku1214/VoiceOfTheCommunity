...
public class CustomItems
{
     ...
     * TODO
     * 
     * Make Winged Spear evolve when having 2 Sun & Moon inscriptions without any other evolve material - done
     * Fix Recovered Fingers' icon white pixel issue - done
     * Fix Small Twig's description - done
     * Fix Blood-Soaked Javelin's crit dmg from 25% to 20%. - done
     * Re-sprite Ice Spear and its evolution - done
     * Separate Attack Speed into basic and skill attack speed - done
     * Replace unneeded ability icons to null - done
     * Buff Tattered Cat Plushie - done
     * Edit Omen: Accursed Sabre's lore - done
     * Add Korean translation for spawning text - done
     * Re-sprite Accursed Sabre - done
     * Re-sprite Cross Necklace - done
     * Re-sprite Spear of the Frozen Moon again - done
     * 
     * Make Disorientation Device - done
     * Make Soul Flame Scythe - done
     * Make Carleon Commander's Bihänder - done
     * Make Rusty Shovel - done
     * Make Crimson Cap - done
     * Make Devil's Mask - done
     * Make Forgotten Sword & its evolution - done
     * Make Demon-Guard's Training Sword - done
     * Make Shield of the Unrelenting - done
     * Make The Sword of the Protector - done
     * Make Runic Paintbrush - done
     * Make Omen: Cursed Shield - done
     * Make Omen: Horcrux Pendant - done
     * Make Bottled Faeling - done
     * Make Ginga Pachinko and its evolution - done
     * Make Becchi - done
     * Make Standard-issue Mining Pick and its evolution - done
     * Make Gazing Eye Brooch - done
     * Make Mana Fountain - done
     * Make Attendant's Cuirass - done
     * Make Sagittarius's Chakram - done
     * Make Gryphon's Feather - done
     * Make Happiest Mask - done
     * Make Blooming Eden - done
     * Make Shieldbone and its evolution - done
     * Make Diary of an Old Master - done
     * Make Steel Aegis - done
     * Make Omen: Cursed Dagger - done
     * Make Sword of the Toxic Moon and its evolution - done
     * 
     * Make Bone of Randomness - done
     * Make Broken Watch (Check new sprite) - done
     * Make Ring Target (Check sprite and details) - done
     * Make Helix Brooch (Check sprite) - done
     * Make Power Halberd - done
     * Make Shadow Thief's Sack - done
     * Make Tetronimo and its bone evolution - done
     * Make Demoman's Bottle - done
     * Make Forgotten Company's Helmet - done
     * Make Damocles (made by plumperdumper2490) - done
     * Make The Endless Cycle - done
     * Make Craftsmans Chisel and its masterpiece evolution (Check sprite change) - done
     * Make Manatech Sequence Breaker - done
     * Make Monk's Bracers and its masterpiece evolution - done
     * Make Makeshift Helmet (if its possible, also check sprite changes) - done
     * Make The Secret of the King (Check changes) - done
     * 
     * Make my own item! (prob a megaphone, desc says "THIS! IS THE VOICE! OF THE COMMUNITY!!!")
     * 
     * Edit Bihander, Disorientation, Training Sword and Horcrux Pendant - done
     * Edit Cursed Shield - done
     * Edit Volcanic Shard - done
     * Edit Sword of Ages - done
     * Edit Crimson Cap - done
     * Resprite Bihander - done
     * Resprite Fonias (Check all versions) - done
     * Resprite Chalices - done
     * Resprite Horcrux Pendant - done
     * 
     * Edit credits in README files
     * Get rid of PhysicsUtils if unused - done
     * Say that Spear of the Frozen Moon's freeze max hit and The Sword of Ages' revives are hard-coded in README files - done
     * Ask creator of Runic Paintbrush for bone evolution - done
     * Creditor Zinier -> Garg defender -> #1 swap enjoyer - done
     * Creditor regularanimegirl -> Chained Champion - done
     */
